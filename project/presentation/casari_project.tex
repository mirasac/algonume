  ...
  \begin{itemize}
    \item Relation between pressure and altitude:
      \begin{equation}
        ...
        \quad .
      \end{equation}
    \note[item]{Equation~\eqref{eq:pressure_altitude} obtained from hydrostatic equilibrium and ideal gas law.}
    \item Relation between optical depth and pressure:
      \begin{equation}
        ...
        \quad .
      \end{equation}
    \note[item]{Equation~\eqref{eq:optical_depth_pressure} obtained from definition of optical depth, hydrostatic equilibrium and hypotheses on attenutation coefficient.}
    \item Relation between optical depth and altitude:
      \begin{equation}
        ...
        \quad .
      \end{equation}
    \note[item]{Equation~\eqref{eq:optical_depth_altitude_2} obtained by combining relations~\eqref{eq:pressure_altitude} and~\eqref{eq:optical_depth_pressure}.}
  \end{itemize}
\end{frame}
  ...
  \begin{itemize}
    \item<1-> RTE for non-scattering medium in LTE:
      \begin{equation}
        ...
        \quad .
      \end{equation}
    \note[item]<1->{RTE describes spectral radiance in a medium.}
  ...
  \begin{itemize}
    ...
    \item<3-> Additional relations:
      \begin{align}
        ...
        \quad .
      \end{align}
    \note[item]<3->{Hypotheses of atmosphere in radiative equilibrium at all altitudes and atmosphere transparent to radiation coming from outside the planet are equivalent to hypotheses of atmosphere in radiative equilibrium at TOA and steady state.}
...
\begin{frame}{Stability analysis}
  \begin{center}
    \includegraphics[keepaspectratio=true,width=\textheight]{stability}
  \end{center}
  \note{
    \begin{itemize}
...
\begin{frame}{Time integration}
  \begin{itemize}
    ...
    \note[item]<1->{
      The iterations continue until a steady state for temperature is reached:
      \begin{enumerate}
        ...
        \item the resulting $E_\text{U}$ and $E_\text{D}$ are used to step forward $T$ with respect to $t$ for each layer;
    ...
    \item<2-> Additional normalisation:
      \begin{equation}
        ...
        \quad .
      \end{equation}
    \note[item]<2->{Same initial conditions for analytical solution are used, point $Y_3(0, 0)$ is not used during the integration.}
    ...
    \note[item]<3->{Integration over vertical coordinate remains unchanged.}
  \end{itemize}
\end{frame}

\begin{frame}{Errors of time integration at steady state}
  \begin{center}
    \includegraphics[keepaspectratio=true,width=\textheight]{errors_PDE}
  \end{center}
  \note{
    \begin{itemize}
