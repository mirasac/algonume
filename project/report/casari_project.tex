...
\begin{table*}[h]
  ...
  \begin{tabular}[b]{cccp{0.5\textwidth}}
    ...
    %$A_\text{g}$      & \num{0.1}                                                              &                                                   & Average surface albedo of Earth, cf. \cite[217]{primer}                                  \\
...
\onecolumn
\lstinputlisting[caption={File \texttt{main.cpp}.},label={lst:main.cpp},language=C++,style=mystyle]{../code/main.cpp}
\lstinputlisting[caption={File \texttt{constants.h}.},label={lst:constants.h},language=C++,style=mystyle]{../code/constants.h}
\twocolumn
