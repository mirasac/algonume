...
\begin{table*}[h]
  ...
  \begin{tabular}[b]{cccc}
    ...
    $\alpha$         & \num{0.3}              &                                                & Value compatible with various measures, cfr. \cite{albedo} \\
    \bottomrule
  \end{tabular}
\end{table*}
...
Instead, in $[\nu_\text{div}, \qty{100000}{\per\centi\metre}]$ Earth's surface irradiance is \qty{0.16}{\percent} of the total irradiance in this interval and is neglected. The removed quantity is \qty{0.54}{\percent} of the total Earth's surface irradiance. % MC talk about uncertainties?
