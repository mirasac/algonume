...
\begin{equation}
  ...
  \quad ,
\end{equation}
where $\E_\text{U}(z)$ and $\E_\text{D}(z)$ are radiant fluxes of upward and downward radiations, respectively.
...
% MC talk about diffusive radiation and the factor 1.66.
