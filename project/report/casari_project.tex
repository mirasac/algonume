...
Sun's surface is approximated as an emitting blackbody. Solar radiation is considered orthogonal to the plane which represents Earth's surface in the RCM. Constant value $S_0$ for total solar irradiance is used in calculations.

% MC check the following.
...
The accuracy of the approximation can be quantified by the overlap between distributions considering the splitted spectra. Planck's law is used to evaluate the 
